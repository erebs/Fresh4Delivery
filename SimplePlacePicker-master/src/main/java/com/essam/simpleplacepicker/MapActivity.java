...
//        mapView2 = (MapView) findViewById(R.id.map_fragment);
//        mapView2.getMapAsync(this);
//        mapView = mapView2.getRootView();
...
//                ToDo : you can use retrofit for this network call instead of using services
    ...
    private void updateUi() {
        ...
        if (addressResultCode == SimplePlacePicker.SUCCESS_RESULT) {
            ...
            Lan = currentMarkerPosition.latitude+"";
            Lon = currentMarkerPosition.longitude+"";
